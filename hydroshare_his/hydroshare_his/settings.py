"""
Django settings for hydroshare_his project.
...
SECRET_KEY = '8*%8v)rjwn8h2y&e$bx%updl=pb6ncxbfzy+jit%-1_n8poj)7'
...
ROOT_URLCONF = 'hydroshare_his.urls'
...
WSGI_APPLICATION = 'hydroshare_his.wsgi.application'
